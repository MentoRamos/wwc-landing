...
const MEDIA = [
  { src: '/photos/presenting.jpg', alt: 'Keynote — CEO Quantificado', type: 'photo' as const },
  { src: '/photos/hero-keynote.jpg', alt: 'Kauã Ramos palestrando', type: 'photo' as const },
  ...
  { src: '/photos/kaua-portrait-color.jpg', alt: 'Kauã Ramos — Host', type: 'photo' as const },
  { src: '/photos/kaua-portrait-bw.jpg', alt: 'Kauã Ramos — Retrato P&B', type: 'photo' as const },
