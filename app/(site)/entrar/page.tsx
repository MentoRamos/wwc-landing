...
export default async function EntrarPage({
  ...
  return (
    ...
    <div className="grid flex-1 lg:min-h-[calc(100vh-4rem)] lg:grid-cols-2">
      {/* A metade da imagem. No telefone ela não some, encolhe: uma metade
          roubaria a dobra e empurraria o botão para baixo do teclado, mas
          esconder tudo devolvia a tela que o commit anterior tinha
          consertado, uma coluna estreita sozinha no preto. Doze rem é alto o
          bastante para a foto existir e baixo o bastante para o botão
          continuar acima da dobra em qualquer telefone. */}
      <div className="relative h-48 lg:h-auto">
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-gradient-to-b from-transparent to-[var(--bg)] lg:bg-gradient-to-r lg:from-[var(--bg)]/70 lg:via-transparent lg:to-[var(--bg)]"
        />
      ...
      <div className="flex items-center justify-center px-6 py-14 lg:px-16 lg:py-20">
        <div className="w-full max-w-sm">
          ...
          {/* A frase acima diz "entre assim mesmo" e não dava endereço nenhum
              para quem comprou com outro e-mail. A página que responde isso
              existe desde o começo e não era alcançável daqui. */}
          <p className="mt-6 text-xs text-[var(--text-3)]">
            <Link href="/sem-acesso" className="link-draw text-[var(--accent)]">
              Comprei e o acesso não apareceu
            </Link>
          </p>
